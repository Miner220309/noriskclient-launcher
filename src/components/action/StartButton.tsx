      ...
      onClick={async () => {
        ...
        await invoke({
          ...
          args: [
            ...
            `-cp`,
            `${mcDir}/libraries/com/mojang/netty/1.6/netty-1.6.jar;
            ${mcDir}/libraries/oshi-project/oshi-core/1.1/oshi-core-1.1.jar;
            ${mcDir}/libraries/net/java/dev/jna/jna/3.4.0/jna-3.4.0.jar;
            ...
            ${mcDir}/libraries/io/netty/netty-all/4.0.23.Final/netty-all-4.0.23.Final.jar;
            ${mcDir}/libraries/com/google/guava/guava/17.0/guava-17.0.jar;
            ${mcDir}/libraries/org/apache/commons/commons-lang3/3.3.2/commons-lang3-3.3.2.jar;
            ${mcDir}/libraries/commons-io/commons-io/2.4/commons-io-2.4.jar;
            ${mcDir}/libraries/commons-codec/commons-codec/1.9/commons-codec-1.9.jar;
            ...
            ${mcDir}/libraries/com/mojang/authlib/1.5.21/authlib-1.5.21.jar;
            ${mcDir}/libraries/com/mojang/realms/1.7.59/realms-1.7.59.jar;
            ...
            ${mcDir}/libraries/tv/twitch/twitch/6.5/twitch-6.5.jar;
